...
"[project]/app/api/profile/balance/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        // Get profile balance
        const { data: profile, error } = await supabase.from('profiles').select('credit_balance').eq('email', email).maybeSingle();
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b28adeed._.js.map