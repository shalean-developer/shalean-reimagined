...
"[project]/app/api/voucher/list/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        // Build query
        let query = supabase.from('vouchers').select('id, code, amount, status, valid_from, valid_until, created_at, redeemed_at', {
            count: 'exact'
        }).order('created_at', {
            ascending: false
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5d2da997._.js.map