module.exports = [
"[project]/app/admin/data:5bb6a5 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$admin$2f$data$3a$5bb6a5__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/admin/data:5bb6a5 [app-ssr] (ecmascript) <text/javascript>");
...
function PaymentsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: async ()=>{
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$admin$2f$data$3a$5bb6a5__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getAllBookings"])();
    ...
    // Calculate statistics (divide by 100 to convert from cents to rands)
    const totalAmount = bookings.reduce((sum, b)=>sum + (b.total_amount || 0) / 100, 0);
    const paidAmount = bookings.filter((b)=>b.payment_status === 'paid').reduce((sum, b)=>sum + (b.total_amount || 0) / 100, 0);
    const pendingAmount = bookings.filter((b)=>b.payment_status === 'pending').reduce((sum, b)=>sum + (b.total_amount || 0) / 100, 0);
    if (loading) {
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    booking.amount_paid > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        ...
                                                                        children: [
                                                                            "Paid: R",
                                                                            ((booking.amount_paid || 0) / 100).toFixed(2)
                                                                        ]
                                                                    }, void 0, true, {
                                                                        fileName: "[project]/app/admin/(dashboard)/payments/page.tsx",
                                                                        lineNumber: 201,
...
//# sourceMappingURL=_66480cc2._.js.map