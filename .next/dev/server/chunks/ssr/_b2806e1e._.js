module.exports = [
"[project]/app/cleaner/(dashboard)/layout-client.tsx [app-rsc] (client reference proxy) <module evaluation>", ((__turbopack_context__) => {
"use strict";
...
;
const CleanerLayoutClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call CleanerLayoutClient() from the server but CleanerLayoutClient is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/app/cleaner/(dashboard)/layout-client.tsx <module evaluation>", "CleanerLayoutClient");
}),
"[project]/app/cleaner/(dashboard)/layout-client.tsx [app-rsc] (client reference proxy)", ((__turbopack_context__) => {
"use strict";
...
const CleanerLayoutClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call CleanerLayoutClient() from the server but CleanerLayoutClient is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/app/cleaner/(dashboard)/layout-client.tsx", "CleanerLayoutClient");
}),
"[project]/app/cleaner/(dashboard)/layout-client.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$cleaner$2f28$dashboard$292f$layout$2d$client$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/app/cleaner/(dashboard)/layout-client.tsx [app-rsc] (client reference proxy) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$cleaner$2f28$dashboard$292f$layout$2d$client$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__ = __turbopack_context__.i("[project]/app/cleaner/(dashboard)/layout-client.tsx [app-rsc] (client reference proxy)");
;
__turbopack_context__.n(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$cleaner$2f28$dashboard$292f$layout$2d$client$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__);
}),
...
"[project]/src/lib/utils/cleaner-earnings.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/cleaner/actions.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$cleaner$2d$earnings$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/utils/cleaner-earnings.ts [app-rsc] (ecmascript)");
...
async function authenticateCleaner(phone, password) {
    try {
        ...
        if (!cleaner.auth_user_id) {
            try {
                const adminSupabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$server$2d$admin$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createAdminClient"])();
...
async function getCurrentCleaner() {
    try {
        ...
        const { data: cleaner, error: cleanerError } = await supabase.from('cleaners').select('*').eq('id', cleanerId).eq('is_active', true).maybeSingle();
...
async function calculateBookingEarnings(bookingId) {
    try {
        ...
        const tenureMonths = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$cleaner$2d$earnings$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["calculateCleanerTenure"])(cleaner.created_at);
        const totalHours = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$cleaner$2d$earnings$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["calculateTotalHours"])(cleanerBookings);
        const earningsPercentage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$cleaner$2d$earnings$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getEarningsPercentage"])(tenureMonths, totalHours);
        // Calculate base earnings
        // Equipment fee and additional cleaners charges are excluded from cleaner earnings
        const baseEarnings = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$cleaner$2d$earnings$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["calculateCleanerEarnings"])({
        ...
        const tipAmount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$cleaner$2d$earnings$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["calculateTipPerCleaner"])(Number(booking.tip_amount) || 0, booking.preferred_cleaner_ids, booking.preferred_cleaner_id);
        return {
            success: true,
            earnings: {
                baseEarnings,
...
async function getCleanerStats() {
    try {
        ...
        const tenureMonths = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$cleaner$2d$earnings$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["calculateCleanerTenure"])(cleaner.created_at);
        const totalHours = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$cleaner$2d$earnings$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["calculateTotalHours"])(allBookings);
        const earningsPercentage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$cleaner$2d$earnings$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getEarningsPercentage"])(tenureMonths, totalHours);
        ...
        const totalEarnings = completedPaidBookings.reduce((sum, booking)=>{
            const earnings = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$cleaner$2d$earnings$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["calculateTotalEarningsFromBooking"])({
                service_type: booking.service_type || '',
                total_amount: Number(booking.total_amount) || 0,
                service_fee: Number(booking.service_fee) || 0,
                equipment_supply_price: Number(booking.equipment_supply_price) || 0,
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getCleanerByPhone, "40e9c8b809fbb28f2cba0e39ec8776dc28f8f26b39", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(authenticateCleaner, "60666f28190d6935704cc8de97891a902db58432f2", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getCurrentCleaner, "00cfc5487decda11050aba4d6adfc04c97edf6800a", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getCleanerBookings, "40a21f4363e61128aa708111c03e4b8f9a91215864", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(calculateBookingEarnings, "404229d4a2391f70ae4e1636e65b58ce0172045828", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getCleanerBookingById, "407424f522637094128af18ea51884b5441885865a", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(updateBookingStatus, "60a12ddac75796db4d4d4fc60138884ab06d6e90be", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(reportLateness, "700855f263225f386c33ac1ae426b438ad205851f1", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(calculateBookingsEarnings, "400c3b38a11e4946f9888927b9dcc25cc258d8b9d2", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getCleanerStats, "006374c708226613b4f9f179bdcc22f548734a4b98", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(updateCleanerAvailability, "60973a8852eb904057fe83de54e909caee8024cf23", null);
}),
"[project]/app/cleaner/(dashboard)/layout.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$cleaner$2f28$dashboard$292f$layout$2d$client$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/cleaner/(dashboard)/layout-client.tsx [app-rsc] (ecmascript)");
...
async function CleanerDashboardLayout({ children }) {
    try {
        ...
        const cleanerResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$cleaner$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getCurrentCleaner"])();
        if (!cleanerResult.success || !cleanerResult.cleaner) {
            // Not authenticated - redirect to login
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$navigation$2e$react$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["redirect"])('/cleaner/login?redirect=/cleaner');
        }
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$cleaner$2f28$dashboard$292f$layout$2d$client$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["CleanerLayoutClient"], {
            children: children
        }, void 0, false, {
...
//# sourceMappingURL=_b2806e1e._.js.map