...
"[project]/app/dashboard/data:11415c [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/dashboard/data:a9d068 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dashboard$2f$data$3a$a9d068__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/dashboard/data:a9d068 [app-ssr] (ecmascript) <text/javascript>");
'use client';
;
;
;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const loadUserProfile = async ()=>{
            try {
                ...
                const authResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dashboard$2f$data$3a$11415c__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getAuthenticatedUser"])();
                if (authResult.success && authResult.email) {
                    setUserEmail(authResult.email);
                    // Fetch profile to get avatar and name
                    const profileResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dashboard$2f$data$3a$a9d068__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getCustomerProfile"])(authResult.email);
        ...
        const { data: { subscription } } = supabase.auth.onAuthStateChange(async (_event, session)=>{
            if (session?.user?.email) {
                ...
                try {
                    const profileResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dashboard$2f$data$3a$a9d068__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getCustomerProfile"])(session.user.email);
                    if (profileResult.success && profileResult.profile) {
                        setProfile(profileResult.profile);
                        if (profileResult.profile.first_name && profileResult.profile.last_name) {
                            setUserInitials((profileResult.profile.first_name[0] + profileResult.profile.last_name[0]).toUpperCase());
...
//# sourceMappingURL=_c8f0f71c._.js.map