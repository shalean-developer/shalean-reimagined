...
"[project]/app/admin/actions-client.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$admin$2f$actions$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/admin/actions-client.ts [app-client] (ecmascript)");
...
function AdminLoginForm() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const trimmedPassword = password.trim();
            if (!trimmedEmail || !trimmedPassword) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Please enter both email and password');
                setIsLoading(false);
                return;
            }
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$admin$2f$actions$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authenticateAdminClient"])(trimmedEmail, trimmedPassword);
            if (!result.success) {
...
_s(AdminLoginForm, "6pibvQtH8b19Fzv/uYqidllhKFc=", false, function() {
    return [
...
//# sourceMappingURL=_aed88ec2._.js.map