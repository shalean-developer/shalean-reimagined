...
function BookingsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        }["BookingsPage.useQuery"],
        staleTime: 5 * 60 * 1000
    });
    const loadBookings = async (customerEmail)=>{
        try {
            setLoading(true);
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dashboard$2f$data$3a$16f724__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getCustomerBookings"])(customerEmail, undefined, filter);
...
_s(BookingsPage, "ghKJjuROSo+F8+TxQ748Iac2pdA=", false, function() {
    return [
...
//# sourceMappingURL=_4403078d._.js.map