...
"[project]/app/dashboard/data:ca0108 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/dashboard/data:441f5a [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dashboard$2f$data$3a$441f5a__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/dashboard/data:441f5a [app-client] (ecmascript) <text/javascript>");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
            ...
            const loadUserProfile = {
                "DashboardHeader.useEffect.loadUserProfile": async ()=>{
                    try {
                        ...
                        const authResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dashboard$2f$data$3a$ca0108__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getAuthenticatedUser"])();
                        if (authResult.success && authResult.email) {
                            setUserEmail(authResult.email);
                            // Fetch profile to get avatar and name
                            const profileResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dashboard$2f$data$3a$441f5a__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getCustomerProfile"])(authResult.email);
            ...
            const { data: { subscription } } = supabase.auth.onAuthStateChange({
                "DashboardHeader.useEffect": async (_event, session)=>{
                    if (session?.user?.email) {
                        ...
                        try {
                            const profileResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dashboard$2f$data$3a$441f5a__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getCustomerProfile"])(session.user.email);
                            if (profileResult.success && profileResult.profile) {
                                setProfile(profileResult.profile);
                                if (profileResult.profile.first_name && profileResult.profile.last_name) {
                                    setUserInitials((profileResult.profile.first_name[0] + profileResult.profile.last_name[0]).toUpperCase());
...
//# sourceMappingURL=_dd873a04._.js.map